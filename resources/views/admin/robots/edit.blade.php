            ...
            <tr>
                ...
                <td>
                    ...
                    @foreach($rooms as $k => $room)
                            <input type="checkbox" name="rooms[]" value="{{$room->id}}"  id="menu_c_{{$k}}" @if($robot->rooms->where('id', $room->id)->isNotEmpty()) checked @endif><label for="menu_c_{{$k}}"> {{ $room->name }}</label>
                        @endforeach
                    </span>
