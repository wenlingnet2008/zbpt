...
@section('content')
    ...
    <form method="post" action="{{route('admin.brands.store')}}" id="dform" onsubmit="return check();" enctype="multipart/form-data">
        {{csrf_field()}}
        <table cellspacing="0" class="tb">
            <tr>
                <td class="tl"><span class="f_red">*</span> 品牌名称</td>
                <td><input name="name" type="text" size="30" value="" id="name"/><br/><span id="dname"
                                                                                            class="f_red"></span></td>
            </tr>
            <tr>
